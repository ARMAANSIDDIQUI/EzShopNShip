...
export default function AdminUsersPage() {
  const [users, setUsers] = useState([
    ...dummyUsers,
    { id: 4, name: "Alice Johnson", email: "alice@example.com", role: "customer" as const },
    { id: 5, name: "Bob Wilson", email: "bob@example.com", role: "customer" as const },
    { id: 6, name: "Carol Brown", email: "carol@example.com", role: "admin" as const },
  ])
